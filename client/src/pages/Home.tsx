...
const Hero = () => {
  return (
    <section className="relative h-[100svh] flex items-center justify-center text-center px-4 overflow-hidden pt-20">
      <div className="relative z-10 flex flex-col items-center max-w-5xl mx-auto">
        ...
        >
          <div className="flex items-center justify-center gap-3 flex-wrap">
            <span className="font-sans-bold text-white text-5xl tracking-wider">boCHE</span>
            <span className="font-display text-gold text-3xl">&</span>
            <span className="font-display text-gold-gradient text-5xl leading-tight pb-2">ShakesBierre</span>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="font-body italic text-gold-pale text-xl md:text-3xl mt-4 max-w-2xl">
            "Drinketh. Eateth. Meeteth."
          </p>
        </motion.div>
        ...
        >
          <button className="px-10 py-4 bg-gold text-black font-heading font-bold uppercase tracking-[0.2em] text-sm hover:bg-gold-bright transition-colors duration-300 relative overflow-hidden group">
          ...
          <button className="px-10 py-4 border border-gold text-gold font-heading font-bold uppercase tracking-[0.2em] text-sm hover:bg-gold hover:text-black transition-colors duration-300 relative overflow-hidden group">
...
const About = () => {
  return (
    <section id="about" className="relative py-32 bg-[#080500] px-6 border-t border-gold/10 overflow-hidden">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center relative z-10">
        
        {/* Left Side */}
        <div className="flex flex-col gap-8">
          <motion.div initial={{opacity: 0, x: -30}} whileInView={{opacity: 1, x: 0}} viewport={{once: true}} transition={{duration: 0.8}}>
            <p className="font-heading text-gold tracking-[0.3em] uppercase text-sm mb-4">
              <span className="mr-3">★</span> The Venue <span className="ml-3">★</span>
            </p>
            <AnimatedText text="Where The Bard Meets The Beat" className="font-display text-5xl lg:text-7xl text-gold-gradient leading-[1.1] mb-6" />
            <p className="font-body text-cream text-xl lg:text-2xl leading-relaxed max-w-xl text-balance">
          ...
          <div className="grid sm:grid-cols-2 gap-8">
            <motion.div initial={{opacity: 0, y: 20}} whileInView={{opacity: 1, y: 0}} viewport={{once: true}} transition={{delay: 0.2}}>
              <h3 className="font-sans-bold text-white text-xl mb-3 flex items-center gap-2">
                Level 4 · boCHE <span className="font-script text-red-neon text-neon-glow font-normal text-2xl ml-1 -mt-1">Club</span>
              </h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {[
            ...
            >
              <span className="font-display text-5xl text-gold mb-3 group-hover:scale-110 transition-transform duration-500">{stat.num}</span>
